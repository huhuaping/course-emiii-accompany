...
::: {.callout-tip title="NEW IDE"}

VS code is a new IDE, which is more popular. here are some useful IDEs based on VS code:

- [Positron](https://positron.posit.co/). It is a new IDE developed by Posit, the company behind RStudio.

- [Cursor](https://www.cursor.com/). It is a new IDE that integrates AI into the IDE.
